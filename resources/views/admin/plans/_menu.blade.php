<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs nav-tabs-top nav-underline">
            ...
            <li  class="nav-item dropdown {{ in_array($menu, ['quota','tier','security','email_footer','tos']) ? 'active' : '' }}" >
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li class="{{ $menu == 'tier' ? 'active' : '' }}">
                        <a class="dropdown-item" href="{{ action('Admin\PlanController@tier', $plan->uid) }}">
                            {{ trans('messages.plan.tier') }}
                        </a>
                    </li>
