                        ...
                        <div class="mb-3 unlimited_control">
                            <div class="d-flex align-items-center">
                                <div class="me-4" style="width:400px">
                                    @include('helpers.form_control.control', [
                                        'type' => 'number',
                                        'name' => 'plan[options][users_max]',
                                        'value' => $options['users_max'],
                                        'label' => trans('messages.max_users'),
                                        'attributes' => [
                                            'default-value' => '100',
                                        ],
                                    ])
                        ...
                        <div class="mb-3 unlimited_control">
                            <div class="d-flex align-items-center">
                                <div class="me-4" style="width:400px">
                                    @include('helpers.form_control.control', [
                                        'type' => 'number',
                                        'name' => 'plan[options][sms_max]',
                                        'value' => $options['sms_max'],
                                        'label' => trans('messages.max_sms'),
                                        'attributes' => [
                                            'default-value' => '100',
                                        ],
                                    ])
