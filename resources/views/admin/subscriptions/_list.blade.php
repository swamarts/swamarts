		...
		@foreach ($subscriptions as $key => $subscription)
			<tr>
				...
				<td>
					...
					<div class="text-muted">{!! !empty($subscription->customer) ? (trans('messages.subscribed_by', [
				...
				<td width="10%">
					{{-- @if ($subscription->isEnded())old code --}}
				...
				<td width="15%">
					@if ($subscription->isActive())
						<h5 class="no-margin stat-num">
							<span class="kq_search">{{ number_with_delimiter($subscription->getSendingCreditsRemaining()) }}</span>
						</h5>
				...
				<td width="15%">
					{{-- @if ($subscription->isActive()) --}}
						<h5 class="no-margin stat-num">
							<span class="kq_search">{{ $subscription->plan->name }}</span>
						</h5>
						<span class="text-muted2">${{ $subscription->plan->price }} {{ trans('messages.plan_basic_price') }}</span>
					{{-- @endif --}}
                </td>
