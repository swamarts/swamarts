            ...
            <div class="ms-auto text-end d-flex align-items-center">
                <div class="text-end d-flex align-items-center ms-auto">
                    ...
                    <div>
                        ...
                        <a href="{{ action('Admin\CategoryController@create') }}" class="btn btn-secondary">
                            <span class="material-symbols-rounded">list</span> {{ trans('messages.add') }} {{ trans('messages.edit') }} {{ trans('messages.template.category') }}
                        </a>
                    </div>
                </div>
            </div>
