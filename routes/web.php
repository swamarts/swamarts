...
Route::group(['middleware' => ['not_installed', 'not_logged_in']], function () {
    ...
    Route::get('users/register', 'UserController@register')->name('customer.register');
});
...
Route::group(['middleware' => ['not_installed', 'auth', 'frontend']], function () {
    ...
    Route::get('account/subscription/order-box', 'SubscriptionController@orderBox'); //old 
    ...
    Route::post('account/subscription/checkoutip', 'SubscriptionController@checkoutIp');
    Route::post('account/subscription/cancel-now', 'SubscriptionController@cancelNow');
    Route::post('account/ip/cancel-now/{ip}', 'SubscriptionController@cancelIpNow');
    ...
    Route::resource('account/utm', 'GoogleUTMController');
    ...
    Route::get('account/users/listing', 'AccountController@listing');
    Route::get('account/users/create', 'AccountController@create');
    Route::post('account/users/store', 'AccountController@storeUser');
    Route::get('account/users/edit/{uid}', 'AccountController@editUser');
    Route::delete('account/users/delete', 'AccountController@deleteUser');
    Route::patch('account/users/update/{uid}', 'AccountController@updateUser');
    Route::get('account/status/{uid}', 'AccountController@statusUser');
...
Route::group(['middleware' => ['not_installed', 'auth', 'frontend', 'subscription']], function () {
    ...
    Route::get('account/help_and_support', 'WebsiteController@helpAndSupport');
...
Route::group(['namespace' => 'Admin', 'middleware' => ['not_installed', 'auth', 'backend']], function () {
    ...
    Route::get('admin/plans/{uid}/tier', 'PlanController@tier');
    ...
    //ipaddress
    Route::get('admin/ipaddress/listing/{page?}', 'MailIpAddressController@listing');
    Route::resource('admin/ipaddress', 'MailIpAddressController');
    Route::get('admin/assignIp/{user_id}', 'MailIpAddressController@assignIp');
...
Route::get('plan_embed', 'HomeController@planEmbed');